...
export class WidgetsDropdownComponent implements OnInit, AfterContentInit {
  ...
  setOptions() {
    for (let idx = 0; idx < 4; idx++) {
      // console.log('this.optionsDefault', this.optionsDefault)
  ...
  getBlanceGeneral(){
    this.balanceService.getBlanceGeneral().subscribe( (res: any) => {
      this.balanceGeneral = res.data.data.available_balance
    })
  }
}
